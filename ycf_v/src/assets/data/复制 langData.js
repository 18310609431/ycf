const messages={
	en: {
		...
		tech: {
			...
			one:'NO.1',
				oneContent:'基于业务和信任分离协作的新一代区块链平台架构，作为社群IaaS，支持“一键式”实现不同安全等级、不同性能指标和不同可信等级的社群链平台和应用， 支持不同安全、性能和可信等级取舍的社群链平台和应用的和谐共存',
				two:'NO.2',
				twoContent:'支持实现完全私密的专属区块链社群平台和社群应用，做到相关方对社群和社群应用的数据、代码和软硬件运营环境的完全控制。平台内建对系统错误和敌对攻击的自动响应（resilient to failure and hostility），并内置支持运行环境的可靠自检、交叉验证等生产级安全措施，实现平台级安全',
				three:'NO.3',
				threeContent:'基于专利保护的高性能共识算法，创造性的大幅度改善区块链的性能指标，同时支持超大规模、超低延迟、超高吞吐、超高并发和区块链集群的自由伸缩，满足现实应用对平台性能的苛刻要求',
				// dlklTitle:'多链跨链',
				// dlklContent:'自动多链、自动跨链，自动适配未来的区块链协议栈引擎',
				// dgsTitle:'多共识',
				// dgsContent:'支持全链共识、应用级共识、交易级共识',
				four:'NO.4',
				fourContent:'延伸区块链和智能合约到智能手机、平板电脑和IoT设备端，支持实现端到端的自动信任',
				five:'NO.5',
				fiveContent:'支持使用多种主流编程语言创建社群应用（java，go，javascript，c/c++等），助力快速形成应用生态',
				six:'NO.6',
				sixContent:'内建基于活跃度证明（PoA：Proof-of-Activeness）、贡献证明（PoC：Proof-of-Contribution）的透明激励模型（PDX Incentivization Model），通过内置符合ERC20标准的虚拟货币（蜂巢币， HCC），激励生态体系的所有参与者和帮助生态体系增长和活跃的所有活动（activity）',
			},
			home:{
				home:"Home",
				tech:"Highlights",
			...
			design:{
				title:"Design Goals",
				iaas:"支持“一键式”创建专属的文创产品生态链。各个文创产品生态链，其内容形式、市场定位、目标客户群、地域覆盖等，可以完全不同。各个文创产品生态链，在PDX咏春坊上同时运行、和谐共存， 并具有真正的全链级的可信强度。",
				net:"支持任意内容的确权举证、高效分发，及其社群互动和衍生商业，并提供易用的工具，以帮助实现高效管理。",
				safe:"零距离对接文创作者、所有权人、用户粉丝和签约商家，实现高效的基于内容的生态。"
			},
			develop:{
				title:"Roadmap",
				timeBaap:"June 2016",
			...
			coin:{
				...
				first:"创作者、所有权人、代理人等，通过PDX咏春坊的文创生态服务链创建接口，基于Web，可以一键式的部署自己的文创生态服务链，以便低成本的快速上线自己的文创生态",
				last:"通过平台内置的机器人推荐，或者经由粉丝社交推荐、转发，消费者（用户、粉丝）获知感兴趣的内容。平台按QoS和地域偏好，高效的推送内容给消费者。在内容推送的过程中，平台自动植入“分发”指纹，以作为将来维权举证的证据",
				three:"由于平台无死角的记录作品上链、分发的全链条证据。 给定一个流通的文字、图片、语音或视频片段，如果是从平台流出的话，平台能够提供完整的证据链条，举证侵权源头"
			},
			team:{
				title:"Team",
				Jgz:"Jiangang Zhang",
		...
		zh: {
			...
			tech: {
				title: '技术特点',
				titleT:"20多项关键性创新，专利保护涵盖共识算法，分布式账本、智能合约等全协议栈",
				one:'NO.1',
				oneContent:'基于业务和信任分离协作的新一代区块链平台架构，作为社群IaaS，支持“一键式”实现不同安全等级、不同性能指标和不同可信等级的社群链平台和应用， 支持不同安全、性能和可信等级取舍的社群链平台和应用的和谐共存',
				two:'NO.2',
				twoContent:'支持实现完全私密的专属区块链社群平台和社群应用，做到相关方对社群和社群应用的数据、代码和软硬件运营环境的完全控制。平台内建对系统错误和敌对攻击的自动响应（resilient to failure and hostility），并内置支持运行环境的可靠自检、交叉验证等生产级安全措施，实现平台级安全',
				...
				fiveContent:'支持使用多种主流编程语言创建社群应用（java，go，javascript，c/c++等），助力快速形成应用生态',
				six:'NO.6',
				sixContent:'内建基于活跃度证明、贡献证明的透明激励模型（PDX Incentivization Model），通过内置符合ERC20标准的虚拟货币（蜂巢币， HCC），激励生态体系的所有参与者和帮助生态体系增长和活跃的所有活动',
			},
			home:{
				home:"首页",
				tech:"技术特点",
			...
			aboutUs:{
				title:"关于我们",
				concent:"咏春坊(WING CHUN FANS)，是一个围绕内容的自主激励、高效分发、确权维权、粉丝互动和衍生商业区块链平台，是利用PDX公有区块链底层技术和生态自激励机制连接创作者、消费者、广告主、品牌商等所有生态体系的参与者，形成有机增长的生态网络。"
			},
			design:{
				title:"设计目标",
				iaas:"支持“一键式”创建专属的文创产品生态链。各个文创产品生态链，其内容形式、市场定位、目标客户群、地域覆盖等，可以完全不同。各个文创产品生态链，在PDX咏春坊上同时运行、和谐共存， 并具有真正的全链级的可信强度。",
			...
			team:{
				title:"核心团队",
				Jgz:"张建钢",
				Jgz_info:"张建钢 · PDX 公有链发起人，华中科技大学学士、中国冶金部自动化研究院硕士。PDX 公有链和 PDX BaaP 的首席架构师。具有 20 年以上的高级技术架构和领导执行经验，在巨型跨国公司领导和决定战略性的技术架构及其实施, 曾任思科美国（CISCO）企业 SDN 部门总监级架构师和部门主管、雅虎全球的首席安全架构师和雅虎公司技术理事会(Tech Council)的高级专家成员、PayPal主管架构师并创建 PayPal Java 基础设施团队、Cingular Wireless (现 AT&T)最高级别的架构师和公司架构评审委员会的专家成员。",
				Tl:"刘挺",
				Tl_info:"刘挺 · 业务和运营总监，计算机科学学士，15+ 年互联网软件销售、业务拓展和运营经验，曾任北京天云融创科技有限公司副经理，普元信息技术股份有限公司销售总监、北京瑞伯图科技有限公司总经理、中蓝投资（深圳）管理有限公司投资顾问等职务。",
				Dms:"尚冬梅",
				Dms_info:"尚冬梅 · 人力行政总监，江苏大学学士学位，具有 10 年以上的人力资源和行政管理经验。",
				Pe:"Peter Ellehauge",
				Pe_info:"Peter Ellehauge ·  PDX 公有链架构师和安全总监， 丹麦技术大学电子工程学士学位。在信息安全和云运营方面，有非常丰富的技术领导经验。曾任雅虎的信息安全总监、Groupon 的高级产品工程师等。",
				Wh:"William Huang",
				Wh_info:"William Huang · PDX 公有链架构师和研发总监，佛罗里达州立大学计算机博士。曾担任 PayPal 主管架构师和高级研发经理，Reuters/Tibco 的主管架构师，在超大规模支付系统、大数据和机器学习领域有非常丰富的经验。",
				Tc:"Tina Chen",
				Tc_info:"Tina Chen · PDX 公有链架构师和研发总监，加拿大约克大学计算机学士。陈女士曾任 IIX （Verisk Analytics）、JP Morgan Chase、Shell Trading、BPAmerica、MCI 的高级软件工程师和架构师。",
				Ns:"Nawien Sharma",
				Ns_info:"Nawien Sharma · PDX 公有链架构师和主要代码贡献者，加拿大温泽大学电子工程学士学位。具有丰富的技术领导经验，曾任雅虎主管级工程师、CenturyLink 的系统架构师、以及微软的高级软件工程师等。",
				Az:"Andy Zhang",
				Az_info:"Andy Zhang · PDX 公有链资深工程师和主要代码贡献者，美国康奈尔大学计算机科学系本科，曾在斯坦福研究院实习、获奖并合作发表文章，将在谷歌实习，曾经参与或主导参与多个人工智能/深度学习项目(Modemo: political bias analyzer,baeML: personalized content platform, fmxnet: deep face analysis platform)。"
			},
			consultant:{
				title:"顾问团队",
				Zwn:"张维宁",
				Zwn_info:"张维宁 · PDX 顾问。张维宁教授现任长江商学院会计学副教授，长江创创社区学术主任，于 2010 年在美国德克萨斯大学达拉斯分校获得会计学博士学位，曾任教于新加坡国立大学商学院。",
				Jl:"梁隽樟",
				Jl_info:"梁隽樟 · PDX 顾问。梁隽樟先生拥有耶鲁大学的 MBA 学位，爱荷华州立大学的计算机和电子工程硕士学位和清华大学的电子工程学士学位。拥有超过 13年的风险投资、投资银行和企业管理经验，于 2016 年 6 月共同创立昆仲资本。此前，梁隽樟先生担任复星昆仲资本总裁，任职期间主导投资了和创科技、量化派、着迷网、徙木金融、博车网、八天在线等优质项目。在复星昆仲资本前，梁隽樟先生担任江铜资本的合伙人。梁隽樟先生亦曾就职于鼎晖创投，主导了对于百世汇通、ASP Solar 及爱国者电子等优质项目。在职业生涯的早期，梁隽樟先生曾经就职于雷曼兄弟、启明星辰和 EMC。",
				Gz:"赵光",
				Gz_info:"赵光 · PDX 顾问。赵光博士拥有密歇根理工大学博士学位、中国科学院硕士学位。赵光博士现任海尔数字 CEO，曾任 Gartner 高级合伙人、专职为超过 60 家国内外政府机构和领军企业（包括中国企业和政府高管）提供战略顾问服务。赵光博士在美国政府机构工作长达 18 年，曾任南卡罗琳娜州常务注册长、部首席信息官、局长、内部审查董事会主席等。"
			}
		}
	}
